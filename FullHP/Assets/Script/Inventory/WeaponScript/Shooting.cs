...
public class Shooting : MonoBehaviour
{
   ...
   public Reload_Canvas reloading;
    ...
    public void Reload()
    {
       ...
       if(currentClip < maxClip && player.pistolAmmo > 0)
        {
            int ammoNeeded = maxClip - currentClip;
            int ammoToReload = Mathf.Min(ammoNeeded, player.pistolAmmo);

            currentClip += ammoToReload;
            player.pistolAmmo -= ammoToReload;
        }
      //  currentClip = maxClip;
    }
    ...
    public void UpdateAmmoText()
    {
        ...
        TotalAmmoText.text = $"{player.pistolAmmo}";
    }
